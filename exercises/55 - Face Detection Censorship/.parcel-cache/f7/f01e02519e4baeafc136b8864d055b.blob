...
})({"ff67eaada5f3d20e90f8f9220db28c96":[function(require,module,exports) {
...
const optionsInputs = document.querySelectorAll('.controls inputs[type="range"]');
console.log(optionsInputs);
const options = {
  SIZE: 10,
  SCALE: 1.35
}; // write a function that will populate a user's video
...
async function populateVideo() {
  ...
  await video.play(); // size the canvasas to be the same size as the video
...
} // grab the face and put it in a square
...
} // pixelate a user's face on top of the stroked area
...
function censor({
  ...
  face.y, options.SIZE, options.SIZE); // draw the small face back on, but scaled up
...
},{}]},{},["dbf1218a5157915fae56d372bc4c8638","ff67eaada5f3d20e90f8f9220db28c96"], null)

//# sourceMappingURL=pixelated-face.e8f7c020.js.map
